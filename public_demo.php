...
function howToPlay(){
  alert(`📖 CARA BERMAIN EnglAI\n\n🎮 QUIZ MODE\n• Kelompok bergantian menjawab pertanyaan pilihan ganda\n• AI Gemini membuat soal; fallback lokal tersedia\n\n🗣️ SPEAKING MODE\n• Kelompok bergantian mengucapkan kalimat dari Unit 1-3\n• Mic aktif menggunakan browser Speech Recognition\n• Feedback menunjukkan kecocokan hasil transkripsi, bukan diagnosis pronunciation\n\n🏆 Juara ditentukan dari total skor.`);
}
