...
<section class="box"><h2>Upload RPP</h2><p>Format yang didukung: PDF dan DOCX.</p><form action="upload_rpp.php" method="post" enctype="multipart/form-data"><?= Csrf::field() ?><input type="file" name="rpp_file" accept=".pdf,.docx,application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document" required> <button type="submit">Upload RPP</button></form></section>
